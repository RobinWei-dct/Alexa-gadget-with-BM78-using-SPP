...
typedef struct _alexaDiscovery_DiscoverResponseEventPayloadProto_Endpoints {
    ...
    alexaDiscovery_DiscoverResponseEventPayloadProto_Endpoints_Capabilities capabilities[6];
...
#define alexaDiscovery_DiscoverResponseEventPayloadProto_Endpoints_init_default {"", "", "", "", 0, {alexaDiscovery_DiscoverResponseEventPayloadProto_Endpoints_Capabilities_init_default, alexaDiscovery_DiscoverResponseEventPayloadProto_Endpoints_Capabilities_init_default, alexaDiscovery_DiscoverResponseEventPayloadProto_Endpoints_Capabilities_init_default, alexaDiscovery_DiscoverResponseEventPayloadProto_Endpoints_Capabilities_init_default, alexaDiscovery_DiscoverResponseEventPayloadProto_Endpoints_Capabilities_init_default, alexaDiscovery_DiscoverResponseEventPayloadProto_Endpoints_Capabilities_init_default}, alexaDiscovery_DiscoverResponseEventPayloadProto_Endpoints_AdditionalIdentification_init_default}
...
#define alexaDiscovery_DiscoverResponseEventPayloadProto_size 3188
#define alexaDiscovery_DiscoverResponseEventPayloadProto_Endpoints_size 3184

...
#define alexaDiscovery_DiscoverResponseEventProto_size (3203 + header_EventHeaderProto_size)
#define alexaDiscovery_DiscoverResponseEventProto_Event_size (3197 + header_EventHeaderProto_size)
